...
namespace Cardif
{
    [Activity(Label = " physical Electronics", MainLauncher = false, Icon = "@drawable/icon", Theme = "@style/Theme2")]
    public class PhysicalElectronics : AppCompatActivity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SupportActionBar.Title = "Physical Electronics";
