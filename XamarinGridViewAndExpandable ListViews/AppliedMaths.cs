...
namespace Cardif
{
    [Activity(Label = "Applied Maths",MainLauncher = false, Icon = "@drawable/icon", Theme ="@style/Theme2")]
    public class AppliedMaths : AppCompatActivity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SupportActionBar.Title="Applied Mathematics";
