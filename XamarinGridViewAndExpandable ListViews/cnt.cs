...
namespace Cardif
{
    [Activity(Label = "Circuit & Network Theory", MainLauncher = false, Icon = "@drawable/icon", Theme = "@style/Theme2")]
    public class cnt : AppCompatActivity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SupportActionBar.Title = "Circuit & Network Theory";
