...
namespace Cardif
{
    [Activity(Label = "Elctrical Measurement", MainLauncher = false, Icon = "@drawable/icon", Theme = "@style/Theme2")]
    public class ElectricalMeasurement : AppCompatActivity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SupportActionBar.Title = "Electrical Measurement";
