...
namespace Cardif
{
    [Activity(Label = "PrinciplesOfMarketing", MainLauncher = false, Icon = "@drawable/icon", Theme = "@style/Theme2")]
    public class PrinciplesOfMarketing : AppCompatActivity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SupportActionBar.Title = " PrinciplesOfMarketing";
