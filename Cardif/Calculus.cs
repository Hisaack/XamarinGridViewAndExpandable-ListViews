...
namespace Cardif
{
    [Activity(Label = "Calculus III", MainLauncher = false, Icon = "@drawable/icon", Theme = "@style/Theme2")]
    public class Calculus : AppCompatActivity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SupportActionBar.Title = "Calculus III";
