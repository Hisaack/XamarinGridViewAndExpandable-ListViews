...
namespace Cardif
{
    [Activity(Label = "programming", MainLauncher = false, Icon = "@drawable/icon", Theme = "@style/Theme2")]
    public class Programming : AppCompatActivity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SupportActionBar.Title = " programming";
